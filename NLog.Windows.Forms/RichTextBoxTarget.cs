...
namespace NLog.Windows.Forms
{
    ...
    public class RichTextBoxTarget : TargetWithLayout
    {
        ...
        protected static IEnumerable<RichTextBoxTarget> GetRichTextBoxTargets(LoggingConfiguration loggingConfiguration)
        {
            return loggingConfiguration.AllTargets.OfType<RichTextBoxTarget>();
        }

        protected static List<RichTextBoxRowColoringRule> CreateDefaultColoringRules()
        {
        ...
        protected delegate void DelSendTheMessageToRichTextBox(RichTextBox textBox, string logMessage, RichTextBoxRowColoringRule rule, LogEventInfo logEvent);
        protected delegate void DelSendTheMessagesToRichTextBox(RichTextBox textBox, MessageInfo[] messages);

        protected readonly DelSendTheMessageToRichTextBox _sendTheMessageToRichTextBox;
        protected readonly DelSendTheMessagesToRichTextBox _sendTheMessagesToRichTextBox;

        protected delegate void FormCloseDelegate();
        ...
        protected readonly List<RichTextBoxRowColoringRule> _rowColoringRules = new List<RichTextBoxRowColoringRule>();
        ...
        protected readonly List<RichTextBoxWordColoringRule> _wordColoringRules = new List<RichTextBoxWordColoringRule>();
        ...
        /// </summary>
        protected readonly object messageQueueLock = new object();
        ...
        /// </summary>
        protected bool supportLinks;

        /// <summary>
        /// Lock for <see cref="linkedEvents"/> dictionary access
        /// </summary>
        protected readonly object linkedEventsLock = new object();
        ...
        /// </summary>
        protected const string LinkPrefix = "link";
        ...
        /// </summary>
        protected static readonly object linkRegexLock = new object();
        ...
        /// </summary>
        protected void CreateAccessoryForm(string formName, string controlName)
        {
            if (formName is null || string.IsNullOrEmpty(formName))
            {
        ...
        protected void AttachToControl(Form form, RichTextBox textboxControl)
        {
        ...
        protected void SendTheMessageToRichTextBox(RichTextBox textBox, string logMessage, RichTextBoxRowColoringRule rule, LogEventInfo logEvent)
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected readonly struct MessageInfo
        {
